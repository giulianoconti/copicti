...
import { getUserOrders, getUsers } from "../../firebase/firebase";
      ...
      <div className="adminUsers-screen">
        <div className="adminUsers-container">
          ...
          {userOrders?.map((order) => (
            <div className="adminUsers-user-container" key={order.id}>
  ...
  return (
    <div className="adminUsers-screen">
      <div className="adminUsers-container">
        ...
        {users?.map((user, i) => (
          <button
            className="adminUsers-user-container"
            onClick={() => navigateToUser(user.email.replace(".", "*"))}
            key={user?.email || i}
          >
            <p className="adminUsers-user-text">
